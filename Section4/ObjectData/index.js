...
console.log('3. Here is the actual data from a job search site, copy all of the data, assign it to a variable or a constant named jobSearch in your code. Log or print it out to see its structure then answer the following questions:');
...
for(let job of jobSearch.hits) {
    console.log('-------------------------------------------------------------------------------------------------------');
    console.log(`Job's title: ${job.jobTitle}\nLocation: ${job.locationVIs}\nSalary: ${job.jobSalary}\nBenefits: ${job.benefits}\nSkill: ${job.skills}\nRequirements: ${job.jobRequirement}`);
}
console.log('-------------------------------------------------------------------------------------------------------'); 
